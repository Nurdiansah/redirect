...
function fetch_data()
{
  ...
  $sql = "SELECT deskripsi_cargo_as, keterangan_as, lokasi_awal, lokasi_akhir, no_po_as, nm_barang_as, satuan_cargo, p_cargo, l_cargo, t_cargo, sum(st.qty_cargo_as) as qty_cargo, sum(st.volume_cargo_as) as volume_cargo_as, sum(st.ton_cargo_as) as ton_cargo_as, sum(st.revton_cargo_as) as revton_cargo_as
...
$content .= '
    <table border="1" color="#4169E1" cellpadding="1" align="center" vertical-align="middle">
      <tr>
        ...
        <th rowspan="2"; style="vertical-align: middle; width: 100px;" >Descriptin Of Work</th>
        <th rowspan="2"; style="vertical-align: middle; width: 90px;" >Location<br>(from/to)</th>
        <th rowspan="2"; style="vertical-align: middle; width: 80px;" >MTD /<br>PO#</th>
        <th rowspan="2"; style="vertical-align: middle; width: 150px;" >Nama Barang</th>
        ...
        <th rowspan="2"; style="vertical-align: middle; width: 40px;" >Volume<br>M<sup>3</sup></th>
        <th rowspan="2"; style="vertical-align: middle; width: 40px;" >Ton</th>
        <th rowspan="2"; style="vertical-align: middle; width: 40px;" >Ton/M<sup>3</sup></th>
        <th rowspan="2"; style="vertical-align: middle; width: 30px;" >Sign</th>
      </tr>
      <tr>
        <th>P</th>
        <th>L</th>
